        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:block">
              <a href="https://wa.me/34631902474?text=Hola,%20me%20interesa%20una%20reseña%20gratuita%20para%20mejorar%20mi%20reputación%20online%20en%20Google.%20¿Podrían%20ayudarme%20con%20más%20información%20sobre%20sus%20servicios?" target="_blank" rel="noopener noreferrer" className="btn-elegant px-6 py-2 font-semibold">
              Reseña Gratuita
              </a>
            </div>
          ...
          <div className={`md:hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
            <div className="py-4 space-y-4 border-t border-subtle mt-4">
              ...
              <div className="pt-4 border-t border-subtle">
                <a 
                  href="https://wa.me/34631902474?text=Hola,%20me%20interesa%20una%20reseña%20gratuita%20para%20mejorar%20mi%20reputación%20online%20en%20Google.%20¿Podrían%20ayudarme%20con%20más%20información%20sobre%20sus%20servicios?" 
                  target="_blank" 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex justify-center lg:justify-start">
                <a href="https://wa.me/34631902474?text=Hola,%20me%20interesa%20una%20reseña%20gratuita%20para%20mejorar%20mi%20reputación%20online%20en%20Google.%20¿Podrían%20ayudarme%20con%20más%20información%20sobre%20sus%20servicios?" target="_blank" rel="noopener noreferrer" className="btn-elegant text-lg font-semibold text-center flex items-center justify-center">
                Reseña gratuita
                </a>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="glass-card p-8 rounded-xl text-center hover-elegant">
              ...
              <a href="mailto:elresenador@outlook.es" className="text-success hover:text-headline transition-colors">
                elresenador@outlook.es
              </a>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-paragraph">
                <li className="flex items-center">
                  ...
                  <a href="mailto:elresenador@outlook.es" className="hover:text-headline transition-colors">
                    elresenador@outlook.es
                  </a>
                </li>
                <li className="flex items-center">
