      ...
      <section className="py-20 bg-card-dark">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <a href="https://wa.me/34632425771?text=Hola,%20me%20interesa%20una%20consulta%20gratuita" target="_blank" rel="noopener noreferrer" className="glass-card p-8 rounded-xl text-center hover-elegant block">
              <div className="w-16 h-16 highlight-bg rounded-full flex items-center justify-center mx-auto mb-6">
